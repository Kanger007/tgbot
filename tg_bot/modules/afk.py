...
def afk(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("{} is now AFK!".format(update.effective_user.username))
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        update.effective_message.reply_text("{} is no longer AFK!".format(update.effective_user.username))
